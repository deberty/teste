		...
		<form class="well" method="POST" action="index.php?pagina=Redirecionador">
			<div class="control-group">
				<div class="controls">	
					...
					<button type="submit" name="salvarCadastroCliente" class="btn" style="margin-right:10px">Salvar</button>
					<button type="submit" name="cancelarCadastroCliente" class="btn">Cancelar</button>
				</div>
			</div>	
		</form>	
	</body>
